...
namespace Ogre	{
    ...
    //-----------------------------------------------------------------------
	void MeshParticleRenderer::_notifyParticleMoved(list<Particle*>::type& currentParticles)
    {   
	...
	void MeshParticleRenderer::_notifyParticleQuota(size_t equota)
	{
        ...
        {
            mMeshParticleVisualDataPool[i] = OGRE_NEW MeshParticleVisualData;
        }
	...
	void MeshParticleRenderer::_destroyVisualData(ParticleVisualData* vis)
	{
		if (vis)
		{
            ...
            OGRE_DELETE mMeshParticleVisualDataPool[index];
