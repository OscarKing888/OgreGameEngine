#ifndef _ANIMATIONRIBBON_H_
#define _ANIMATIONRIBBON_H_

#include "OgreExPrerequisites.h"

namespace Ogre
{
	class _OgreExExport AnimationRibbon :  public Ogre::StringInterface, public Ogre::SimpleRenderable
	{
		struct Vertex
		{
			Ogre::Vector3 pos;
	...
	public:
		...
		/////////////////////////////////////////////////////////////
		AnimationRibbon(unsigned short pointCount = 30, float lifeTime = 1.0f, float ribbonWidth = 100.0f,
		...
		void updateRenderInstance( float time, const Vector3& position, const Quaternion& rot );
		...
		*/
		...
		Ogre::SceneNode* getRootNode() const { return mRootNode; }
		void setRootNode(Ogre::SceneNode* val) { mRootNode = val; }
