...
namespace Ogre {
    ...
    class _OgreExExport ScaleInterpolatorAffector : public ParticleAffector
    {
    public:
	...
	class _OgreExExport ScaleInterpolatorAffectorFactory : public ParticleAffectorFactory
	{
	public:
