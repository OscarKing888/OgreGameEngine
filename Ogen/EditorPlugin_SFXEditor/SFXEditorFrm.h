...
class SFXEditorFrm
	: public CFrameWndEx
	, public SingletonPhoenix<SFXEditorFrm>
	, public ResEditorBase
	, public IEventLisitener
{
	DECLARE_DYNCREATE(SFXEditorFrm)

public:

	virtual ~SFXEditorFrm();
