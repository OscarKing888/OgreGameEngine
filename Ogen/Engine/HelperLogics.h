...
class ListenerFactoryLogic : public Ogre::CompositorLogic, public OgeAlloc
{
public:
	...
	{
		OGRE_DELETE mListeners[destroyedInstance];
...
private:
	typedef map<Ogre::CompositorInstance*, Ogre::CompositorInstance::Listener*>::type ListenerMap;
