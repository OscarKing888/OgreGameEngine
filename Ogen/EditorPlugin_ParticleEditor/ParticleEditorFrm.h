...
class ParticleEditorFrm
	: public CFrameWndEx
	, public SingletonPhoenix<ParticleEditorFrm>
	, public ResEditorBase
	, public IEventLisitener
{
	DECLARE_DYNCREATE(ParticleEditorFrm)

public:

	virtual ~ParticleEditorFrm();
...
protected:
	...
	ParticleEditorFrm();   // standard constructor
	DECLARE_MESSAGE_MAP()
	virtual void DoDataExchange(CDataExchange* pDX);    // DDX/DDV support

	PropertyGrid	_propGrid;
	TimeLinePanel	_timelinePanel;
	ParticleSystemListPanel	_listPanel;
	...
	afx_msg void OnNewParticle();

	afx_msg void OnSaveParticle();
	afx_msg void OnUpdateSaveParticle(CCmdUI* pCmdUI);
